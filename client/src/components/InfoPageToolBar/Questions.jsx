...
function Questions() {
  return (
    <div >
          <h1 className="text-center text-4xl mb-4 font-thin mb-12">שאלות נפוצות</h1>
          ...
          <details className="group py-8 [&_summary::-webkit-details-marker]:hidden" open>
            <summary className="flex items-center justify-between cursor-pointer">
              ...
              <span className="relative ml-1.5 h-5 w-5 flex-shrink-0 text-cyan-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 w-8 h-8 opacity-100 group-open:opacity-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 w-8 h-8 opacity-0 group-open:opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
