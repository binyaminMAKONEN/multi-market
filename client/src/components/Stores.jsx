...
const Stores = ({ store }) => {
  ...
  return (
    ...
    // </div></>
    <div
      className="bg-no-repeat bg-cover bg-center h-44 md:h-[8rem]  w-[100%] m-auto flex flex-col justify-end   mb-3"
      style={{ backgroundImage: `url(${store?.image?.logo})` }}
    >
