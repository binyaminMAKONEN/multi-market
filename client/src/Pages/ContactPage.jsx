...
function ContactPage() {
  ...
  return (
    <div>
        <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[60px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 text-center max-w-[570px] lg:mb-0">
               
                <h2 className="text-dark mb-6 text-center text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-body-color mb-9 text-center text-base leading-relaxed">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                ...
                <form ref={form}  onSubmit={sendEmail}>
                 <div className="relative z-0 mb-6 w-full group">
                  <input type="text"  name="user_name"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                ...
                <div className="relative z-0 mb-6 w-full group">
                  <input type="email" name="user_email"  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  required />
                ...
                <div className="relative z-0 mb-6 w-full group">
                  ...
                  <button type="submit" value="Send" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"  onClick={() => setTimeout(() => {window.location.reload()}, 1500)} >Submit</button>
                </form>
                <div>
                </div>
              </div>
