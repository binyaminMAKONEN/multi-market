       ...
       <div className="bg-gray-100 h-screen">
        <div className="bg-white p-6  md:mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 my-2">הזמנתך הושלמה בהצלחה .</p>
            <p> Have a great day!</p>
            <div className="py-10 text-center">
              <a href="/" onClick={()=>clearFromLocalSotrage()} className="px-12 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3">
                GO BACK 
              </a>
            </div>
          </div>
